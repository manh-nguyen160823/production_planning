odoo.define('erpvn_planning_management.ProductConfigFormRenderer', function (require) {
"use strict";

var FormRenderer = require('web.FormRenderer');
var DemandVariantMixin = require('erpvn_planning_management.DemandVariantMixin');

var ProductConfigFormRenderer = FormRenderer.extend(DemandVariantMixin, {

    events: _.extend({}, FormRenderer.prototype.events, DemandVariantMixin.events, {
    ...
    _checkMode: function () {
        if (this.state.context.configuratorMode === 'edit') {
            this.$('.o_erpvn_planning_management_add').hide();
            this.$('.o_erpvn_planning_management_edit').css('display', 'inline-block');
    ...
    _toggleDisable: function ($parent, isCombinationPossible) {
        DemandVariantMixin._toggleDisable.apply(this, arguments);
        $parent.parents('.modal').find('.o_erpvn_planning_management_add').toggleClass('disabled', !isCombinationPossible);
    },
...
return ProductConfigFormRenderer;
