odoo.define('erpvn_planning_management.OptionalProductsModalDemand', function (require) {
    "use strict";
...
var DemandVariantMixin = require('erpvn_planning_management.DemandVariantMixin');

var OptionalProductsModalDemand = Dialog.extend(ServicesMixin, DemandVariantMixin, {
    events:  _.extend({}, Dialog.prototype.events, DemandVariantMixin.events, {
    ...
    init: function (parent, params) {
        ...
        this.dialogClass = 'oe_demand_optional_products_modal';
    ...
    willStart: function () {
        ...
        var uri = this._getUri("/erpvn_planning_management/show_optional_products");
    ...
    getSelectedProducts: function () {
        ...
        this.$modal.find('.js_product.in_cart:not(.main_product)').each(function () {
            ...
            products.push({
                ...
                'product_tmpl_id': parseInt($item.find('input.product_tmpl_id').val(), 10),
                'quantity': quantity,
    ...
    _onAddOption: function ($modal, $parent, productTemplateId) {
        ...
        this.selectOrCreateProduct(
            ...
            ajax.jsonRpc(self._getUri("/erpvn_planning_management/demand_optional_product_items"), 'call', {
    ...
    _onChangeCombination: function (ev, $parent, combination) {
        ...
        DemandVariantMixin._onChangeCombination.apply(this, arguments);
...
return OptionalProductsModalDemand;
