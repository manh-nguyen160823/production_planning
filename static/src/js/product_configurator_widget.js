odoo.define('erpvn_planning_management.product_configurator', function (require) {
var DemandProductConfiguratorWidget = require('erpvn_planning_management.origin_product_configurator');

/**
 * Extension of the DemandProductConfiguratorWidget to support product configuration.
 ...
 *
 */
DemandProductConfiguratorWidget.include({
    /**
     * Override of erpvn_planning_management.product_configurator Hook
     *
     * @override
    */
    ...
    /**
    * This method is overridden to check if the product_tmpl_id
    ...
    *      the provided product_tmpl_id and its current attribute values
    *
    * @override
    * @private
    */
    ...
    _openProductConfigurator: function (data, dataPointId) {
        ...
        var self = this;
        this.do_action('erpvn_planning_management.erpvn_planning_management_action', {
    ...
    _onEditProductConfiguration: function () {
        ...
        this._openProductConfigurator({
                ...
                default_product_tmpl_id: this.recordData.product_tmpl_id.data.id,
                // default_pricelist_id: this._getPricelistId(),
    ...
    _getMainProductChanges: function (mainProduct) {
        var result = {
            ...
            product_tmpl_id: {id: mainProduct.product_tmpl_id},
    ...
    _productsToRecords: function (products) {
        ...
        _.each(products, function (product) {
            var record = {
                ...
                default_product_tmpl_id: product.product_tmpl_id,
...
return DemandProductConfiguratorWidget;
